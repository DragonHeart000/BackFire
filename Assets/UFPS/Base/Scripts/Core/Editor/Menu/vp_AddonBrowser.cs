...
public class vp_AddonBrowser : EditorWindow
{
    ...
    private static UnityEngine.Networking.UnityWebRequest m_ProductFile;
#else
	...
	private class ProductIcon
	{
        ...
        public UnityEngine.Networking.DownloadHandlerTexture iconHandler;
#else
        public WWW www;
#endif
	...
	public static void Create()
	{
		...
		m_IconsReady = false;
#if UNITY_2018_3_OR_NEWER
        m_ProductFile = UnityEngine.Networking.UnityWebRequest.Get("http://legacy.opsive.com/assets/UFPS/content/assets/ufps/editor/addons.txt");
        m_ProductFile.SendWebRequest();
#else
	...
	{
#if UNITY_2018_3_OR_NEWER
        string[] splitLines = m_ProductFile.downloadHandler.text.Split('\n');
#else
...
#if UNITY_2018_3_OR_NEWER
                    m_Icons[v].Icon = m_Icons[v].iconHandler.texture;
#else
